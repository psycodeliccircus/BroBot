...
module.exports.run = async (bot, message, splitMessage) => {
	...
	if (player1 === undefined) return functions.sendError(message, "Merci de bien vouloir mentionner les joueurs");
	...
	functions.sendEmbed(message, `**Joueur 1: ${player1} : ${random1} \n Joueur 2: ${player2} : ${random2} **`, 'send', false)
